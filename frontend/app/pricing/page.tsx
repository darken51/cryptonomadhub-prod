  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: '1 wallet tracking', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Cost basis: FIFO method (1k tx/year)', included: true },
        { text: '3 wallets (24h auto-sync)', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Compare unlimited countries', included: true },
        { text: 'Unlimited tax simulations', included: true },
        { text: '100 DeFi audits/month + CSV export', included: true },
        { text: '500 AI messages/month (contextualized)', included: true },
        { text: 'Cost basis: all methods (50k tx/year)', included: true },
        { text: 'Tax Optimizer AI 🔥', included: true },
        { text: '15 wallets (24h auto-sync)', included: true },
